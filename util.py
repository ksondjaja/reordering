...
def getCategories(table):
    ...
    query = f"SELECT COLUMN_TYPE AS game_category_names FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_SCHEMA='z626g5v5cqm4y46n' AND TABLE_NAME='{table}' AND COLUMN_NAME='game_category'"
